...
<?php
	...
	public function get_fields_schema()
	{
		...
		return [
			...
			[
				'id'          => 'test_sms',
				'label'       => __("Test Phone Number", 'wp-marketing-automations'),
				'type'        => 'text',
				'placeholder' => "e.g. 60123456789",
				"class"       => 'bwfan-input-wrapper',
				'tip'         => '',
				"description" => __('Enter phone number with country code to send test SMS', 'autonami-automations-connectors'),
				"required"    => false,
			],
			[
				'id'          => 'send_test_sms',
				...
				'send_action' => 'bwf_smsniaga_test_message',
				'send_field'  => [
					'sms_to'            => 'test_sms',
