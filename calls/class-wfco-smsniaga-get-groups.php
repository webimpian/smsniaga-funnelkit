...
class WFCO_SmsNiaga_Get_Groups extends WFCO_Call {
	...
	/**
	 * @return WFCO_SmsNiaga_Get_Grops|null
	 */
	...
	public function process() {
		 ...
		 */
		$this->api_end_point = BWFCO_SmsNiaga::get_api_endpoint( $this->data['account_type'] ) . '/api/groups';
...
return 'WFCO_SmsNiaga_Get_Groups';
