...
class WFCO_SmsNiaga_Oauth_Check extends WFCO_Call {
	...
	/**
	 * @return WFCO_SmsNiaga_Oauth_Check|null
	 */
	...
	public function process() {
		 ...
		 */
		$this->api_end_point = BWFCO_SmsNiaga::get_api_endpoint( $this->data['account_type'] ) . '/api/balance';
...
return 'WFCO_SmsNiaga_Oauth_Check';
